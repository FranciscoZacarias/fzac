...
#include "Math/generated/Math.cgen.h"
...
// @Section: f32
fz_internal inline f32 f32_remap(f32 value, f32 min, f32 max); /* Remaps a value between 0.0 and 1.0 to an arbitrary min/max value */
fz_internal inline f32 f32_lerp(f32 start, f32 end, f32 t);

// @Section: V2f32
fz_internal f32   v2f32_length(V2f32 v); /* Returns the Euclidean length (magnitude) of a 2D vector */
fz_internal f32   v2f32_length_squared(V2f32 v); /* Returns the squared length of a 2D vector (avoids sqrt) */
fz_internal f32   v2f32_dot(V2f32 v1, V2f32 v2); /* Computes the dot product of two 2D vectors */
fz_internal f32   v2f32_cross(V2f32 v1, V2f32 v2); /* Computes the scalar 2D cross product (v1.x*v2.y - v1.y*v2.x) */
fz_internal f32   v2f32_distance(V2f32 v1, V2f32 v2); /* Returns the distance between two 2D points */
fz_internal f32   v2f32_distance_squared(V2f32 v1, V2f32 v2); /* Returns the squared distance between two 2D points */
fz_internal V2f32 v2f32_negate(V2f32 v); /* Negates a 2D vector */
fz_internal V2f32 v2f32_div(V2f32 v1, V2f32 v2); /* Divides two 2D vectors component-wise */
fz_internal V2f32 v2f32_normalize(V2f32 v); /* Returns a normalized (unit length) version of a 2D vector */
fz_internal V2f32 v2f32_transform(V2f32 v, Matrix4 mat); /* Transforms a 2D vector by a 4x4 matrix */
fz_internal V2f32 v2f32_lerp(V2f32 v1, V2f32 v2, f32 amount); /* Linearly interpolates between two 2D vectors */
fz_internal V2f32 v2f32_reflect(V2f32 v, V2f32 normal); /* Reflects a 2D vector about a given normal */
fz_internal V2f32 v2f32_rotate(V2f32 v, f32 angle); /* Rotates a 2D vector by an angle in radians */
fz_internal V2f32 v2f32_move_towards(V2f32 v, V2f32 target, f32 max_distance); /* Moves a vector toward a target by a maximum distance */
fz_internal V2f32 v2f32_invert(V2f32 v); /* Inverts each component of a 2D vector (1/x, 1/y) */
fz_internal b32   v2f32_equals(V2f32 p, V2f32 q); /* Returns true if two 2D vectors are equal component-wise */
fz_internal V2f32 v2f32_refract(V2f32 v, V2f32 n, f32 r); /* Computes the direction of a refracted ray\n v: normalized direction of the incoming ray\n n: normalized normal vector of the interface of two optical media\n r: ratio of the refractive index of the medium from where the ray comes\n to the refractive index of the medium on the other side of the surface */
fz_internal V2f32 v2f32_snap45(V2f32 v); /* Snaps v to the closest 45 degree angle */

// @Section: V3f32
fz_internal V3f32 v3f32_cross(V3f32 v1, V3f32 v2); /* Computes the cross product of two 3D vectors */
fz_internal f32   v3f32_length(V3f32 v); /* Returns the Euclidean length (magnitude) of a 3D vector */
fz_internal f32   v3f32_length_squared(V3f32 v); /* Returns the squared length of a 3D vector (avoids sqrt) */
fz_internal f32   v3f32_dot(V3f32 v1, V3f32 v2); /* Computes the dot product of two 3D vectors */
fz_internal f32   v3f32_distance(V3f32 v1, V3f32 v2); /* Returns the distance between two 3D points */
fz_internal f32   v3f32_distance_squared(V3f32 v1, V3f32 v2); /* Returns the squared distance between two 3D points */
fz_internal V3f32 v3f32_negate(V3f32 v); /* Negates a 3D vector */
fz_internal V3f32 v3f32_div(V3f32 v1, V3f32 v2); /* Divides two 3D vectors component-wise */
fz_internal V3f32 v3f32_normalize(V3f32 v); /* Returns a normalized (unit length) version of a 3D vector */
fz_internal V3f32 v3f32_project(V3f32 v1, V3f32 v2); /* Projects vector v1 onto vector v2 */
fz_internal V3f32 v3f32_reject(V3f32 v1, V3f32 v2); /* Calculates the rejection of the vector v1 on to v2 */
fz_internal void  v3f32_ortho_normalize(V3f32 *v1, V3f32 *v2); /* Orthonormalizes provided vectors.\n Makes vectors normalized and orthogonal to each other.\n Implements the Gram-Schmidt process */
fz_internal V3f32 v3f32_transform(V3f32 v, Matrix4 mat); /* Transforms a 3D vector by a 4x4 matrix */
fz_internal V3f32 v3f32_rotate_by_quaternion(V3f32 v, Quaternion q); /* Rotates a 3D vector using a quaternion */
fz_internal V3f32 v3f32_rotate_by_axis_angle(V3f32 v, V3f32 axis, f32 angle); /* Rotates a 3D vector around an axis by an angle in radians */
fz_internal V3f32 v3f32_move_towards(V3f32 v, V3f32 target, f32 max_distance); /* Moves a vector toward a target by a maximum distance */
fz_internal V3f32 v3f32_lerp(V3f32 v1, V3f32 v2, f32 amount); /* Linearly interpolates between two 3D vectors */
fz_internal V3f32 v3f32_cubic_hermite(V3f32 v1, V3f32 tangent1, V3f32 v2, V3f32 tangent2, f32 amount); /* Calculates cubic hermite interpolation between two vectors and their tangents,\n as described in the GLTF 2.0 specification:\n https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html#interpolation-cubic */
fz_internal V3f32 v3f32_reflect(V3f32 v, V3f32 normal); /* Reflects a 3D vector about a given normal */
fz_internal V3f32 v3f32_barycenter(V3f32 p, V3f32 a, V3f32 b, V3f32 c); /* Computes barycenter coordinates (u, v, w) for point p with respect to triangle (a, b, c).\n Assumes p is on the plane of the triangle */
fz_internal V3f32 v3f32_unproject(V3f32 source, Matrix4 projection, Matrix4 view); /* Projects a V3f32 from screen space into world space */
fz_internal V3f32 v3f32_invert(V3f32 v); /* Inverts each component of a 3D vector (1/x, 1/y, 1/z) */
fz_internal b32   v3f32_equals(V3f32 p, V3f32 q); /* Returns true if two 3D vectors are equal component-wise */
fz_internal V3f32 v3f32_refract(V3f32 v, V3f32 n, f32 r); /* Computes the direction of a refracted ray\n v: normalized direction of the incoming ray\n n: normalized normal vector of the interface of two optical media\n r: ratio of the refractive index of the medium from where the ray comes\n to the refractive index of the medium on the other side of the surface */

// @Section: V4f32
fz_internal f32   v4f32_length(V4f32 v); /* Returns the Euclidean length (magnitude) of a 4D vector */
fz_internal f32   v4f32_length_squared(V4f32 v); /* Returns the squared length of a 4D vector (avoids sqrt) */
fz_internal f32   v4f32_dot(V4f32 v1, V4f32 v2); /* Computes the dot product of two 4D vectors */
fz_internal f32   v4f32_distance(V4f32 v1, V4f32 v2); /* Returns the distance between two 4D points */
fz_internal f32   v4f32_distance_squared(V4f32 v1, V4f32 v2); /* Returns the squared distance between two 4D points */
fz_internal V4f32 v4f32_negate(V4f32 v); /* Negates a 4D vector */
fz_internal V4f32 v4f32_div(V4f32 v1, V4f32 v2); /* Divides two 4D vectors component-wise */
fz_internal V4f32 v4f32_normalize(V4f32 v); /* Returns a normalized (unit length) version of a 4D vector */
fz_internal V4f32 v4f32_lerp(V4f32 v1, V4f32 v2, f32 amount); /* Linearly interpolates between two 4D vectors */
fz_internal V4f32 v4f32_move_towards(V4f32 v, V4f32 target, f32 maxDistance); /* Moves a 4D vector toward a target by a maximum distance */
fz_internal V4f32 v4f32_invert(V4f32 v); /* Inverts each component of a 4D vector (1/x, 1/y, 1/z, 1/w) */
fz_internal b32   v4f32_equals(V4f32 p, V4f32 q); /* Returns true if two 4D vectors are equal component-wise */
...
fz_internal Matrix3 matrix3_transpose(Matrix3 m); /* Transposes a 3x3 matrix */
fz_internal Matrix3 matrix3_multiply(Matrix3 a, Matrix3 b); /* Multiplies two 3x3 matrices (a * b) */
fz_internal V3f32   matrix3_multiply_v3f32(Matrix3 m, V3f32 v); /* Multiplies a 3x3 matrix by a 3D vector */
fz_internal Matrix3 matrix3_translate(V2f32 translation); /* Creates a translation matrix for a 2D vector */
fz_internal Matrix3 matrix3_rotate(f32 radians); /* Creates a rotation matrix (around origin) by given radians */
fz_internal Matrix3 matrix3_scale(V2f32 scale); /* Creates a scaling matrix for a 2D vector */
fz_internal Matrix3 matrix3_ortho(f32 left, f32 right, f32 bottom, f32 top); /* Creates a 2D orthographic projection matrix */
fz_internal Matrix3 matrix3_inverse(Matrix3 m);
...
fz_internal f32     matrix4_determinant(Matrix4 mat); /* Computes the determinant of a 4x4 matrix */
fz_internal f32     matrix4_trace(Matrix4 mat); /* Computes the trace of a 4x4 matrix (sum of diagonal elements) */
fz_internal Matrix4 matrix4_transpose(Matrix4 mat); /* Returns the transpose of a 4x4 matrix */
fz_internal Matrix4 matrix4_inverse(Matrix4 mat); /* Returns the inverse of a 4x4 matrix */
fz_internal Matrix4 matrix4_add(Matrix4 left, Matrix4 right); /* Adds two 4x4 matrices component-wise */
fz_internal Matrix4 matrix4_sub(Matrix4 left, Matrix4 right); /* Subtracts the right 4x4 matrix from the left component-wise */
fz_internal Matrix4 matrix4_mul(Matrix4 left, Matrix4 right); /* Multiplies two 4x4 matrices */
fz_internal V3f32   matrix4_mul_v3f32(Matrix4 m, V3f32 v, f32 w);
fz_internal Matrix4 matrix4_translate(f32 x, f32 y, f32 z); /* Creates a translation matrix for the given x, y, z offsets */
fz_internal Matrix4 matrix4_rotate(V3f32 axis, f32 angle); /* Creates a rotation matrix around a given axis by an angle in radians */
fz_internal Matrix4 matrix4_rotate_X(f32 angle); /* Creates a rotation matrix around the X-axis by an angle in radians */
fz_internal Matrix4 matrix4_rotate_Y(f32 angle); /* Creates a rotation matrix around the Y-axis by an angle in radians */
fz_internal Matrix4 matrix4_rotate_Z(f32 angle); /* Creates a rotation matrix around the Z-axis by an angle in radians */
fz_internal Matrix4 matrix4_rotate_XYZ(V3f32 angle); /* Creates a combined rotation matrix around the X, Y, and Z axes in order XYZ (angles in radians) */
fz_internal Matrix4 matrix4_rotate_ZYX(V3f32 angle); /* Creates a combined rotation matrix around the Z, Y, and X axes in order ZYX (angles in radians) */
fz_internal Matrix4 matrix4_scale(f32 scale); /* Creates a scaling matrix with scale factors for each axis */
fz_internal Matrix4 matrix4_scale_xyz(f32 x, f32 y, f32 z); /* Creates a scaling matrix with scale factors for each axis */
fz_internal Matrix4 matrix4_frustum(f64 left, f64 right, f64 bottom, f64 top, f64 near_plane, f64 far_plane); /* Creates a perspective frustum projection matrix\n defined by the given left, right, bottom, top, near, and far planes */
fz_internal Matrix4 matrix4_perspective(f64 fovY, f32 window_width, f32 window_height, f64 near_plane, f64 far_plane); /* Creates a perspective projection matrix using a vertical field of view in radians\n with the given aspect ratio, near, and far planes */
fz_internal Matrix4 matrix4_ortho(f64 left, f64 right, f64 bottom, f64 top, f64 nearPlane, f64 farPlane); /* Creates an orthographic projection matrix defined by the given planes */
fz_internal Matrix4 matrix4_look_at(V3f32 eye, V3f32 target, V3f32 up); /* Creates a view matrix that looks from 'eye' toward 'target' using the 'up' direction */
fz_internal Matrix4 matrix4_from_quaternion(Quaternion q); /* Creates a Matrix4 from the given quaternion */
fz_internal Matrix4 matrix4_from_transform(Transform t); /* Creates a Matrix4 from the given transform */
fz_internal String  matrix4_to_string(Arena *arena, Matrix4 m); /* Creates a string out of a matrix4 */ 
...
fz_internal Quaternion quaternion_add(Quaternion q1, Quaternion q2); /* Adds two quaternions component-wise */
fz_internal Quaternion quaternion_sub(Quaternion q1, Quaternion q2); /* Subtracts the second quaternion from the first component-wise */
fz_internal f32        quaternion_length(Quaternion q); /* Returns the length (magnitude) of a quaternion */
fz_internal Quaternion quaternion_normalize(Quaternion q); /* Returns a normalized (unit length) quaternion */
fz_internal Quaternion quaternion_invert(Quaternion q); /* Returns the inverse of a quaternion */
fz_internal Quaternion quaternion_mul(Quaternion q1, Quaternion q2); /* Multiplies two quaternions (combines rotations) */
fz_internal Quaternion quaternion_scale(Quaternion q, f32 mul); /* Scales each component of a quaternion by a scalar */
fz_internal Quaternion quaternion_div(Quaternion q1, Quaternion q2); /* Divides one quaternion by another (q1 * inverse(q2)) */
fz_internal Quaternion quaternion_lerp(Quaternion q1, Quaternion q2, f32 amount); /* Performs linear interpolation between two quaternions */
fz_internal Quaternion quaternion_nlerp(Quaternion q1, Quaternion q2, f32 amount); /* Calculates normalized linear interpolation (nlerp) between two quaternions.\n Provides a faster approximation of slerp */
fz_internal Quaternion quaternion_slerp(Quaternion q1, Quaternion q2, f32 amount); /* Calculates spherical linear interpolation (slerp) between two quaternions */
fz_internal Quaternion quaternion_cubic_hermite_spline(Quaternion q1, Quaternion out_tangent1, Quaternion q2, Quaternion in_tangent2, f32 t); /* Calculates quaternion cubic spline interpolation using the Cubic Hermite Spline algorithm,\n as described in the GLTF 2.0 specification:\n https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html#interpolation-cubic */
fz_internal Quaternion quaternion_from_v3f32_to_v3f32(V3f32 from, V3f32 to); /* Creates a quaternion representing the rotation from one vector to another */
fz_internal Quaternion quaternion_from_matrix4(Matrix4 mat); /* Converts a rotation matrix to a quaternion */
fz_internal Matrix4    quaternion_to_matrix4(Quaternion q); /* Converts a quaternion to a rotation matrix */
fz_internal Quaternion quaternion_from_axis_angle(V3f32 axis, f32 angle); /* Creates a quaternion representing a rotation around an axis by an angle in radians */
fz_internal Quaternion quaternion_from_x_axis_angle(f32 angle); /* Creates a quaternion representing a rotation around the x axis by an angle in radians */
fz_internal Quaternion quaternion_from_y_axis_angle(f32 angle); /* Creates a quaternion representing a rotation around the y axis by an angle in radians */
fz_internal Quaternion quaternion_from_z_axis_angle(f32 angle); /* Creates a quaternion representing a rotation around the z axis by an angle in radians */
fz_internal void       quaternion_to_axis_angle(Quaternion q, V3f32 *out_axis, f32 *out_angle); /* Extracts the rotation axis and angle (in radians) from a quaternion */
fz_internal Quaternion quaternion_from_euler(f32 pitch, f32 yaw, f32 roll); /* Creates a quaternion equivalent to Euler angles (Z-Y-X rotation order)\n Angles must be provided in radians */
fz_internal V3f32      quaternion_to_euler(Quaternion q); /* Converts a quaternion to Euler angles (roll, pitch, yaw)\n Returns angles in radians as a V3f32 struct */
fz_internal Quaternion quaternion_transform(Quaternion q, Matrix4 mat); /* Transforms a quaternion by a 4x4 matrix */
fz_internal b32        quaternion_equals(Quaternion p, Quaternion q); /* Returns true if two quaternions are equal component-wise */
fz_internal V3f32      quaternion_rotate_v3f32(Quaternion q, V3f32 v);
fz_internal String     quaternion_to_string(Arena *arena, Quaternion q); /* Creates a string out of a quaternion */
...
fz_internal Transform transform_apply(Transform a, Transform b); /* Applies transform a onto transform b */
fz_internal String    transform_to_string(Arena *arena, Transform t); /* Creates a string out of a transform */

// @Section: Implementation

#include "Math/generated/Math.cgen.c"

fz_internal inline f32
...
matrix4_mul_v3f32(Matrix4 m, V3f32 v, f32 w)
{
  ...
  result.x = m.m0  * v.x + m.m4  * v.y + m.m8  * v.z + m.m12 * w;
  result.y = m.m1  * v.x + m.m5  * v.y + m.m9  * v.z + m.m13 * w;
  result.z = m.m2  * v.x + m.m6  * v.y + m.m10 * v.z + m.m14 * w;
...
{
  Quaternion result;
  result = quaternion_from_axis_angle(v3f32(1,0,0), angle);
  return result;
}
...
{
  Quaternion result;
  result = quaternion_from_axis_angle(v3f32(0,1,0), angle);
  return result;
}
...
{
  Quaternion result;
  result = quaternion_from_axis_angle(v3f32(0,0,1), angle);
  return result;
}
...
fz_internal Transform
transform_apply(Transform t, Transform applied_to)
{
  Transform result;

  result.scale    = v3f32_mul(t.scale, applied_to.scale);
  result.rotation = quaternion_mul(t.rotation, applied_to.rotation);

  V3f32 scaled_translation = v3f32_mul(t.scale, applied_to.translation);
  result.translation = v3f32_add(t.translation, quaternion_rotate_v3f32(t.rotation, scaled_translation));
...
transform_to_string(Arena *arena, Transform t)
{
  ...
  String rotation    = quaternion_to_string(arena, t.rotation);
  String scale       = v3f32_to_string(arena, t.scale);
