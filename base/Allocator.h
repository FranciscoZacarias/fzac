...
// @Section: Allocator
typedef struct Allocator Allocator; /* Allocator slot structure that holds fz_internal pointers to an actual allocator */
struct Allocator
{
...
fz_internal void* _stdlib_alloc(u64 bytes, void* context); /* Allocates memory with the stdlib calloc fz_internal */
fz_internal void* _stdlib_alloc_no_zero(u64 bytes, void* context); /* Allocates memory with the stdlib malloc fz_internal */
fz_internal void* _stdlib_free(u64 bytes, void* ptr, void* context); /* Calls free on memory allocated with stdlib allocator */
