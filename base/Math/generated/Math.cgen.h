...
function Rectf32 rectf32_from_position_size(V2f32 pos, V2f32 size);
function V2f32   rectf32_size(Rectf32 rect);
function V2f32   rectf32_center(Rectf32 rect);
function f32     rectf32_width(Rectf32 rect);
function f32     rectf32_height(Rectf32 rect);
function f32     rectf32_area(Rectf32 rect);
function b32     rectf32_contains_point(Rectf32 rect, V2f32 point);
function b32     rectf32_contains_rect(Rectf32 a, Rectf32 b);
function b32     rectf32_overlaps(Rectf32 a, Rectf32 b);
function Rectf32 rectf32_translate(Rectf32 rect, V2f32 offset);
...
function Rectu32 rectu32_from_position_size(V2u32 pos, V2u32 size);
function V2u32   rectu32_size(Rectu32 rect);
function V2u32   rectu32_center(Rectu32 rect);
function u32     rectu32_width(Rectu32 rect);
function u32     rectu32_height(Rectu32 rect);
function u32     rectu32_area(Rectu32 rect);
function b32     rectu32_contains_point(Rectu32 rect, V2u32 point);
function b32     rectu32_contains_rect(Rectu32 a, Rectu32 b);
function b32     rectu32_overlaps(Rectu32 a, Rectu32 b);
function Rectu32 rectu32_translate(Rectu32 rect, V2u32 offset);
function Rectu32 rectu32_intersection(Rectu32 a, Rectu32 b);
function Rectu32 rectu32_union(Rectu32 a, Rectu32 b);

typedef struct Rects32 Rects32;
struct Rects32 { V2s32 min; V2s32 max; };
#define rects32(min,max) (Rects32){(min),(max)}
function Rects32 rects32_from_position_size(V2s32 pos, V2s32 size);
function V2s32   rects32_size(Rects32 rect);
function V2s32   rects32_center(Rects32 rect);
function s32     rects32_width(Rects32 rect);
function s32     rects32_height(Rects32 rect);
function s32     rects32_area(Rects32 rect);
function b32     rects32_contains_point(Rects32 rect, V2s32 point);
function b32     rects32_contains_rect(Rects32 a, Rects32 b);
function b32     rects32_overlaps(Rects32 a, Rects32 b);
function Rects32 rects32_translate(Rects32 rect, V2s32 offset);
function Rects32 rects32_intersection(Rects32 a, Rects32 b);
function Rects32 rects32_union(Rects32 a, Rects32 b);
