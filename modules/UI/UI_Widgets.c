...
function UI_Signal ui_slider_s32(String unique, String text, s32 *val, s32 min, s32 max, f32 width);
function UI_Signal ui_slider_u32(String unique, String text, u32 *val, u32 min, u32 max, f32 width);
