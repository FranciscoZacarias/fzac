...
vulkan_load_global_functions()
{
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateInstance"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumerateInstanceExtensionProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumerateInstanceLayerProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumerateInstanceVersion"), S("Vulkan.cgen"), 0);
    return false;
  }
...
vulkan_load_instance_functions(VkInstance instance)
{
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumeratePhysicalDevices"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumeratePhysicalDeviceGroups"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCreateDevice)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateDevice"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumerateDeviceExtensionProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEnumerateDeviceLayerProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceSurfaceSupportKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceSurfaceCapabilitiesKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceSurfaceFormatsKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceSurfacePresentModesKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateWin32SurfaceKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceToolPropertiesEXT"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateDebugUtilsMessengerEXT"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyInstance"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroySurfaceKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyDebugUtilsMessengerEXT"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkSubmitDebugUtilsMessageEXT"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceFeatures"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceFeatures2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceProperties2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceMemoryProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceQueueFamilyProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceFormatProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceImageFormatProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceFormatProperties2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceImageFormatProperties2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceSparseImageFormatProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceSparseImageFormatProperties2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceExternalBufferProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceExternalFenceProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetPhysicalDeviceExternalSemaphoreProperties"), S("Vulkan.cgen"), 0);
    return false;
  }
...
vulkan_load_device_functions(VkDevice device)
{
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDeviceWaitIdle"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkQueueSubmit)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkQueueSubmit"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkQueueSubmit2)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkQueueSubmit2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkQueueWaitIdle"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateSwapchainKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetSwapchainImagesKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkAcquireNextImageKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateCommandPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkAllocateCommandBuffers"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkBeginCommandBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkEndCommandBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateSemaphore"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCreateFence)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateFence"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkWaitForFences"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkResetFences)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkResetFences"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCreateBuffer)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCreateImage)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateImage"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateImageView"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateSampler"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkAllocateMemory"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateShaderModule"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreatePipelineLayout"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateGraphicsPipelines"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateComputePipelines"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateDescriptorSetLayout"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateDescriptorPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkAllocateDescriptorSets"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateRenderPass"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateRenderPass2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateFramebuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCreateQueryPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetQueryPoolResults"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyDevice"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetDeviceQueue"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkGetDeviceQueue2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroySwapchainKHR"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkDestroyImage)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyImage"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyImageView"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroySampler"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkFreeMemory)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkFreeMemory"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyShaderModule"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyPipeline"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyPipelineLayout"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyDescriptorSetLayout"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyDescriptorPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkFreeDescriptorSets"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyRenderPass"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyFramebuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyQueryPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroySemaphore"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkDestroyFence)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyFence"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkResetCommandPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkDestroyCommandPool"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkFreeCommandBuffers"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBeginRenderPass"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdEndRenderPass"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBeginRenderPass2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdEndRenderPass2"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBindPipeline"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBindDescriptorSets"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBindVertexBuffers"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBindIndexBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCmdDraw)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdDraw"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdDrawIndexed"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCmdDispatch)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdDispatch"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdCopyBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCmdCopyImage)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdCopyImage"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  if (!__vkCmdBlitImage)
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdBlitImage"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdCopyBufferToImage"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdCopyImageToBuffer"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdPipelineBarrier"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdPushConstants"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetViewport"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetScissor"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetLineWidth"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetDepthBias"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetBlendConstants"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetDepthBounds"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetStencilCompareMask"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetStencilWriteMask"), S("Vulkan.cgen"), 0);
    return false;
  }
  ...
  {
    message_box(S("Vulkan"), S("Unable to load Vulkan fz_internal: vkCmdSetStencilReference"), S("Vulkan.cgen"), 0);
    return false;
  }
