...
_opengl_load_functions()
{
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateShaderProgramv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGetUniformLocation"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!glCreateProgram)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateProgram"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCheckNamedFramebufferStatus"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!glGetString)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGetString"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glMapNamedBufferRange"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!glGetError)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGetError"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniform1i"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniform1f"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniform2f"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniform3f"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniform4f"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniformMatrix4fv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniformMatrix2fv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glAttachShader)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glAttachShader"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glLinkProgram)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glLinkProgram"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glDeleteShader)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteShader"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteProgram"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glGetProgramiv)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGetProgramiv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGetProgramInfoLog"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGenProgramPipelines"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glBindProgramPipeline"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glUseProgramStages"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteProgramPipelines"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateBuffers"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glNamedBufferData"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glNamedBufferSubData"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteBuffers"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glBindBuffer)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glBindBuffer"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glNamedBufferStorage"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateProgramPipelines"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateVertexArrays"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glVertexArrayVertexBuffer"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glEnableVertexArrayAttrib"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glVertexArrayAttribFormat"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glVertexArrayAttribBinding"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glBindVertexArray"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteVertexArrays"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glVertexArrayBindingDivisor"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateTextures"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glTextureStorage2D"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glTextureSubImage2D"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glTextureParameteri"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glBindTextureUnit"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteTextures"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glCreateFramebuffers"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glNamedFramebufferTexture"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glNamedFramebufferRenderbuffer"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDeleteFramebuffers"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glBindFramebuffer"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glDrawArrays)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDrawArrays"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glDrawElements)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDrawElements"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDrawArraysInstanced"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDrawElementsInstanced"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glClearColor)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glClearColor"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDebugMessageCallback"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glEnable)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glEnable"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glGetIntegerv)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glGetIntegerv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glVertexArrayAttribIFormat"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glUniform1iv)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glUniform1iv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glUseProgram)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glUseProgram"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniform1iv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glPolygonMode)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glPolygonMode"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glDepthRangef)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glDepthRangef"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glLineWidth)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glLineWidth"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glVertexArrayElementBuffer"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glProgramUniformMatrix3fv"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glViewport)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glViewport"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glBlendFunc)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glBlendFunc"), S("OpenGL.cgen"), 0);
    return false;
  }
  ...
  if (!__glClear)
  {
    error_box(S("OpenGL"), S("Unable to load opengl function: glClear"), S("OpenGL.cgen"), 0);
    return false;
  }
